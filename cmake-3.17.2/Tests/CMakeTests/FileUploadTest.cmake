file(REMOVE_RECURSE "/home/ec2-user/mu/cmake-3.17.2/Tests/CMakeTests/uploads")

if(EXISTS "/home/ec2-user/mu/cmake-3.17.2/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/home/ec2-user/mu/cmake-3.17.2/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/home/ec2-user/mu/cmake-3.17.2/Tests/CMakeTests/uploads")

set(filename "/home/ec2-user/mu/cmake-3.17.2/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/home/ec2-user/mu/cmake-3.17.2/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/home/ec2-user/mu/cmake-3.17.2/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/ec2-user/mu/cmake-3.17.2/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/ec2-user/mu/cmake-3.17.2/Tests/CMakeTests/uploads/file2.png"
